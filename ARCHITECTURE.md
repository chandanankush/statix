...
- **Dashboard** — Chart.js-powered page (`server/templates/dashboard.html`) that:
  - Renders live trend charts (CPU %, Per-Core CPU %, Load Average, RAM % + Swap %, Disk I/O, Network I/O) with drag-to-reorder.
